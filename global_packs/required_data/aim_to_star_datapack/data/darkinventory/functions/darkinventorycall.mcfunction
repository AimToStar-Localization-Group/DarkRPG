...
tellraw @s ["",{"text":"清空所有饰品槽 ","color":"aqua"},{"text":"点击这里","bold":true,"color":"red","clickEvent":{"action":"run_command","value":"/trigger voidtrinkets"},"hoverEvent":{"action":"show_text","contents":"注意如果你点击了这里，你的饰品栏物品将会被全部清除"}},{"text":"\n "}]
